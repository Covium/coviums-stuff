...
<template>
  ...
  >
    ...
    >
      <progress
        class="bg-obsidian-950 [&::-webkit-progress-bar]:bg-obsidian-950 [&::-webkit-progress-value]:bg-obsidian-800 [&::-moz-progress-bar]:bg-obsidian-800 absolute -z-1 h-full w-full appearance-none"
        :max="toast.duration"
